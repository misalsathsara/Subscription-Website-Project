    ...
    <main>
        <div>
            ...
            <div class="row">
                ...
                $queries = [
                    'orders' => ["SELECT COUNT(id) AS total FROM orders", 'red', 'bi-pie-chart', 'Orders'],
                    ...
                    'sales' => ["SELECT SUM(total_price) AS total FROM orders", 'green', 'bi-handbag', 'Total Sales']
                ];
            ...
            $salesQueryCurrent = "SELECT SUM(total_price) AS total_sales FROM orders WHERE MONTH(order_date) = MONTH(CURDATE()) AND YEAR(order_date) = YEAR(CURDATE()) AND payment_status = 'paid' ";
            ...
            $salesQueryPrevious = " SELECT SUM(total_price) AS total_sales FROM orders WHERE MONTH(order_date) = MONTH(CURDATE()) - 1 AND YEAR(order_date) = YEAR(CURDATE()) AND payment_status = 'paid' ";
        ...
        function renderChart(months, salesData, revenueData) {
            ...
            const options = {
                ...
                series: [{
                    ...
                    {
                        name: 'Revenue',
                        data: revenueData.length ? revenueData : null
                    },
                ],
                grid: {
                    borderColor: '#e0e6ed',
    ...
    $(document).ready(function() {
        ...
        function renderMonthlyChart(months, salesData, revenueData) {
            ...
            const options = {
                ...
                xaxis: {
                    categories: months
                }, // Display months as x-axis labels
                yaxis: {
                    labels: {
                        show: true
                    }
...
<style>
    ...
    .table {
        width: 100%;
        margin-bottom: 0;
        /* Remove margin to handle overflow correctly */
    }
    ...
    thead th {
        ...
        /* Optional: Change to match your design */
        z-index: 10;
    }
    ...
    .card1 .card1-title {
        ...
        /* Bold for emphasis */
        color: #34495e;
        /* Rich modern text color */
        text-transform: uppercase;
        /* Uppercase for modern feel */
        letter-spacing: 1px;
        /* Elegance through spacing */
        margin: 0;
    }
