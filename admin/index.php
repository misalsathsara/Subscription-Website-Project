...
<style>
    ...
    .mouse a {
        ...
        /* Remove default underline from the link */
        color: inherit;
        /* Keep the text color the same as the rest of the list item */
    }
    ...
    .todocompleted {
        border-left: 20px solid #7DF9FF;
        /* Adds a 10px border with blue color */
        border-radius: 5px;
        /* Optional: gives the border rounded corners */
        padding: 10px;
        /* Optional: adds padding inside the list item */
    }
            ...
            <ul class="todo-list" id="todoList">
                <li class="todopending mouse" onclick="window.location.href='pending.php';">
                    <p>Pending Process &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        ...
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        <span style="background-color: #FF7F7F; padding: 5px 10px 5px 10px; border-radius: 5px"> count <?php echo $pending_count; ?></span>
                    </p>
                ...
                <li class="todoprocess mouse" onclick="window.location.href='process.php';">
                    <p>Processing Items &nbsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        ...
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        <span style="background-color: #90EE90; padding: 5px 10px 5px 10px; border-radius: 5px"> count <?php echo $processing_count; ?></span>
                    </p>
                    </p>
                    <i class='bx bx-dots-vertical-rounded'></i>
                </li>
                ...
                <li class="todoshipent mouse" onclick="window.location.href='shipment.php';">
                    <p>Shipped Items
                        ...
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        <span style="background-color: #FFFF00; padding: 5px 10px 5px 10px; border-radius: 5px"> count <?php echo $shipped_count; ?></span>
                    </p>
                    </p>
                    <i class='bx bx-dots-vertical-rounded'></i>
                </li>
                ...
                <li class="todocompleted mouse" onclick="window.location.href='delivered.php';">
                    <p>Delivered &nbsp;
                        ...
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        <span style="background-color: #7DF9FF; padding: 5px 10px 5px 10px; border-radius: 5px"> count <?php echo $delivered_count; ?></span>
                    </p>
                    </p>
                    <i class='bx bx-dots-vertical-rounded'></i>
                </li>
