    ...
    <div class="container">
        ...
        <table id="pendingOrders" class="display table table-striped table-bordered">
            ...
            <tbody>
                ...
                $query = "SELECT id FROM orders WHERE order_status = 'processed'";
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <br>
                <h6 class="modal-title" id="nIdModalLabel">If item has Shipped click on Shipped Button</h6>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="submitBtn" class="btn btn-primary">Shipped</button>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function () {
    $('#pendingOrders').DataTable({
        ...
        $('#submitBtn').on('click', function () {
            ...
            $.ajax({
                url: 'update_order_shipment.php',
                method: 'POST',
                data: { order_id: currentOrderId, status: 'shipped' },
                success: function (response) {
